...
See aurarouter.telemetry_config for full documentation.
Copy kept separate to preserve release-cycle independence.
"""
...
def is_external_telemetry_enabled() -> bool:
    ...
    if override is not None:
        logger.info(
            "Telemetry: %s via %s", "enabled" if override else "disabled", _TELEMETRY_ENV_VAR
        )
        return override
